...
const ReSearchBtn = () => {
	...
	return isMoved && isInSeoul && center !== DEFAULT_LOCATION ? (
		<button
			...
			${!isSidebarOpen && 'xl:left-[calc(50dvw_+_43px_-_80px)] xl:right-[calc(50dvw_-_195px_+_80px)]'}
			${isSidebarOpen && 'xl:left-[calc(50dvw_+_195px_-_80px)] xl:right-[calc(50dvw_-_195px_+_80px)]'} 
