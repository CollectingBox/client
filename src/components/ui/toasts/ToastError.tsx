...
export default function ToastError({ title, description, className }: Props) {
	...
	return (
		<div
			...
			} fixed bottom-[50px] max-w-[400px] xl:bottom-[S-24] ${isOpen ? 'xl:left-[402px]' : 'xl:left-[110px]'}  w-[95dvw] xl:w-[360px] flex gap-S-8 px-S-20 py-S-12 z-50 rounded-lg bg-[#92908e] Elevation-2-Bottom transition-opacity duration-500`}
		>
			<Alert color="white" />
